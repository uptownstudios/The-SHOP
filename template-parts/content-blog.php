			...
			<?php if ( $loop->have_posts()) : while ( $loop->have_posts()) : $loop->the_post(); ?>
				<article id="post-<?php the_ID(); ?>" <?php post_class('index-card bs-isotope-item'); ?>>
					<div class="entry-content">
						...
						<span class="avatar alt-avatar"><?php echo get_avatar( get_the_author_meta( 'ID' ), 50 ); ?></span>
						<?php } ?>
						<div class="blog-page-title-excerpt">
							...
							<p class="author-byline"><?php if ( !has_post_thumbnail() ) { ?><span class="avatar"><?php echo get_avatar( get_the_author_meta( 'ID' ), 50 ); ?></span><?php } ?><span class="byline">By <a href="<?php echo get_author_posts_url( $author_id ); ?>" title=""><?php the_author_meta( 'display_name', $author_id ); ?></a></span>
							<?php the_excerpt(); ?></p>
